            ...
            if (u == null) {
                ...
                if ("admin".equalsIgnoreCase(role)) {
                    try (PrintWriter out = response.getWriter()) {
                        ...
                        out.println("<li><a href='ForumManager'>Gestion de forum</a></li>");
                    ...
                    try (PrintWriter out = response.getWriter()) {
                        ...
                        out.println("<html>");
                        out.println("<head>");
                        out.println("<title>Navigation utilisateur</title>");
                        out.println("</head>");
                        out.println("<body>");
                        out.println("<h1>Hello " + session.getAttribute("login") + "</h1>");
                        out.println("<nav> <ul>");
                        out.println("<li><a href='SubscriptionManager?type=all'>Gestion des abonnements</a></li>");
                        out.println("<li><a href='SubscriptionManager?type=my'>Liste de mes forums</a></li>");
                        out.println("<li><a href='Deconnexion'>Déconnecter</a></li>");
                        out.println("</ul>");
                        out.println("</nav>");
                        out.println("</body>");
